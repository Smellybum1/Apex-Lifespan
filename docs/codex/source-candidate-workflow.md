...
Candidate list rows print `packet="..."` and `referenceMatches="..."` for read-only review plus source-query, ingestion-job trace fields, and compact `reviewFlags` plus a `flags="..."` drill-in when applicable.
