...
Sibling headings print `targetPacket="..."`, `targetReferenceMatches="..."`, and target curation-status/draft hints for the target candidate, and rows print `packet="..."`, `referenceMatches="..."`, and curation-status/draft hints for read-only review of related candidates plus `targetReviewFlags`/`reviewFlags` and a `flags="..."` drill-in when applicable.
Duplicate identity rows print `identityList="..."` for the filtered duplicate group and `packet="..."`, `referenceMatches="..."`, `siblings="..."`, curation-status/draft hints, `reviewFlags`, and `flags="..."` for each candidate row when applicable.
