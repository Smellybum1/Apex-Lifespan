...
Candidate list rows print `packet="..."` for read-only packet review plus source-query, ingestion-job trace fields, and compact `reviewFlags` plus a `flags="..."` drill-in when applicable.
