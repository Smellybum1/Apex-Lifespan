...
When emitted beside a row or review group, `flags="..."` stays broad while `flagFocus="..."` includes the first listed flag plus the row context filters for claim, intervention, region, and source; copy `flagFocus` exactly for a narrowed read-only focus view.
...
Duplicate identity rows print `identityList="..."` for the filtered duplicate group and `packet="..."`, `referenceMatches="..."`, `siblings="..."`, curation-status/draft, and exact `groupList="..."` hints, plus `reviewFlags`, `flags="..."`, and `flagFocus="..."` for each candidate row when applicable.
