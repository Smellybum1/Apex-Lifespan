...
Review packets print read-only follow-up commands, conditional duplicate and review-flag hints, and accept/reject templates; write templates still require explicit human review.
