...
Review packets print read-only follow-up commands, curation-status/draft hints, conditional duplicate and focused review-flag hints, explicit accept-gate booleans, and accept/reject templates; write templates still require explicit human review notes.
