...
Curation handoff rows print read-only packet, reference-match, sibling, curation-status, curation-draft hints, accepted-reference/review-note fields for reviewed rows, and compact `reviewFlags`/`reviewCautions` plus `flags="..."` and `flagFocus="..."` drill-ins when applicable.
Curation status and draft rows print read-only packet, reference-match, sibling, group-list, paired curation-view hints, Not-accepted accept-gate booleans, accepted-reference/review-note fields for reviewed rows, and compact `reviewFlags`/`reviewCautions` plus `flags="..."` and `flagFocus="..."` drill-ins when applicable.
