...
Duplicate identity rows print `identityList="..."` for the filtered duplicate group and `packet="..."`, `referenceMatches="..."`, `siblings="..."`, curation-status/draft, and exact `groupList="..."` hints, plus `reviewFlags` and `flags="..."` for each candidate row when applicable.
