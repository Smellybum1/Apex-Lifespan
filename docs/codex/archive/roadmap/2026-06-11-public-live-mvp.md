...
None for the public seed-backed MVP/demo. Public URL is `https://apex-lifespan.vercel.app`.

Completion notes:

- GitHub push limit was lifted on 2026-06-11; pushing to GitHub is allowed when useful.
- First Vercel production deploy on `main` failed because the clean build did not generate Prisma Client before Next type checking; fixed by running `scripts/generate-prisma-client.ts` before `next build`.
- Public smoke passed on 2026-06-11 with `npm run smoke:public-mvp -- https://apex-lifespan.vercel.app`.
- Source-candidate curation remains deferred from public MVP scope; latest snapshot still has 49 pending candidates and 1 accepted candidate that remains local claim-link curation backlog.
...
11. [x] Deploy the public MVP/demo.
    ...
    Completed 2026-06-11: `https://apex-lifespan.vercel.app` rendered the dashboard, and `npm run smoke:public-mvp -- https://apex-lifespan.vercel.app` passed homepage caveats, PubMed live preview, ClinicalTrials.gov live preview, and invalid-term guards.

12. [x] Publish launch handoff.
    ...
    Completed 2026-06-11: `docs/codex/public-mvp-launch-handoff.md` records the public URL, seed data mode, production branch, production fix commit, final public smoke result, known limitations, rollback path, and remaining fully-live gaps.

13. [x] Rollover this roadmap.
    ...
    Completed 2026-06-11: this roadmap was archived at `docs/codex/archive/roadmap/2026-06-11-public-live-mvp.md`, and `docs/codex/roadmap.md` now targets the fully live end product.
