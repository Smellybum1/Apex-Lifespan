...
- `--candidate-siblings` prints match reasons, `targetPacket="..."`, `targetReferenceMatches="..."`, target curation-status/draft heading hints, duplicate hints plus `duplicateCaution` when the target PMID/NCT identity repeats, row-level `packet="..."`, `referenceMatches="..."`, and curation-status/draft hints, and compact `targetReviewFlags`/`reviewFlags` plus `flags="..."` and `flagFocus="..."` drill-ins when applicable.
