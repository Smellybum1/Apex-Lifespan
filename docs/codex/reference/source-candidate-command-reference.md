...
- `--candidates` defaults to pending rows, prints `packet="..."`, `referenceMatches="..."`, `siblings="..."`, curation-status/draft hints, duplicate hints plus `duplicateCaution` when the PMID/NCT identity repeats, query/job trace fields, and compact `reviewFlags` plus `flags="..."` and `flagFocus="..."` drill-ins when applicable, and can filter by source, region, external id, job, intervention, missing intervention, claim, missing claim, or decision.
