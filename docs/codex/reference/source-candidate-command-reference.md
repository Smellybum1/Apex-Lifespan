...
- `--candidate-siblings` prints match reasons, `targetPacket="..."`, `targetReferenceMatches="..."`, and target curation-status/draft heading hints, row-level `packet="..."`, `referenceMatches="..."`, and curation-status/draft hints, and compact `targetReviewFlags`/`reviewFlags` plus a `flags="..."` drill-in when applicable.
