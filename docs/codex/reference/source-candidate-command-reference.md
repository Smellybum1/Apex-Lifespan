...
- `--candidate-review-flags` filters the bounded review overview to flagged top candidates only, can narrow with `--candidate-review-flag`, and prints read-only `flags`, `list="..."`, `packet="..."`, `overview="..."`, and top-identity duplicate hints when applicable.
