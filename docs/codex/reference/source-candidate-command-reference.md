...
- When a row or group emits both `flags="..."` and `flagFocus="..."`, `flags` stays broad and `flagFocus` adds the first listed flag plus the row context filters for claim, intervention, region, and source for an exact read-only focus view.
...
- `--candidates --candidate-duplicates` groups duplicate PMID/NCT identities and prints read-only `identityList="..."`, `packet="..."`, `referenceMatches="..."`, `siblings="..."`, curation-status/draft, exact `groupList="..."` hints, and compact `reviewFlags` plus `flags="..."` and `flagFocus="..."` drill-ins when applicable.
