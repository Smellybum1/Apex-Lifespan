...
- `--candidate-curation-status` and `--candidate-curation-draft` report readiness for public source packets, not evidence quality, and print read-only packet/reference/group/paired-curation hints plus compact `reviewFlags` and a `flags="..."` drill-in when applicable.
- `--candidate-curation-handoff` reports accepted-candidate readiness for public source packets, not evidence quality, and non-empty rows print read-only packet/reference/status/draft hints plus compact `reviewFlags` and a `flags="..."` drill-in when applicable.
