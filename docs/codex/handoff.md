...
Refreshed on 2026-06-04 after adding Not-accepted accept-gate hints to curation views. Verify local state with `git status -sb` and `git log -1 --oneline` before edits.
...
Current code validation for curation accept-gate hints:
