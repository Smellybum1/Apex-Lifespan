  ...
  it("prints read-only backlog summary without running jobs", async () => {
    ...
    expect(stdout).toHaveBeenCalledWith(
      [
        ...
        '- status="Accepted reference missing" publicSourcePacketReady=false: 1 nextAction="Attach or restore the matching curated reference before public packet review." handoff="--candidate-curation-handoff --candidate-curation-handoff-status missing-reference"',
        '- status="Accepted reference mismatch" publicSourcePacketReady=false: 1 nextAction="Replace the accepted reference with one matching the candidate source and external id." handoff="--candidate-curation-handoff --candidate-curation-handoff-status reference-mismatch"',
        '- status="Candidate claim missing" publicSourcePacketReady=false: 1 nextAction="Review or queue this candidate with a claim id before public packet review." handoff="--candidate-curation-handoff --candidate-curation-handoff-status candidate-claim-missing"',
        '- status="Claim link missing" publicSourcePacketReady=false: 1 nextAction="Link the accepted reference to the candidate claim before public packet review." handoff="--candidate-curation-handoff --candidate-curation-handoff-status claim-link-missing"',
        '- status="Extraction pending" publicSourcePacketReady=false: 1 nextAction="Add structured study extraction for the accepted reference." handoff="--candidate-curation-handoff --candidate-curation-handoff-status extraction-pending"',
        '- status="Public source packet ready" publicSourcePacketReady=true: 1 nextAction="Review for public source packet inclusion." handoff="--candidate-curation-handoff --candidate-curation-handoff-status ready"',
