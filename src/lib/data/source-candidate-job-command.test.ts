...
describe("runSourceCandidateJobCommand", () => {
  ...
  it("prints an empty source-candidate accepted-reference match list", async () => {
    ...
    expect(stdout).toHaveBeenCalledWith(
      [
        `Source-candidate accepted-reference matches: total=0 dedupe="clinicaltrials.gov|au|creatine|nct123" key=${safeCandidateKey("clinicaltrials.gov|au|creatine|nct123")} candidate="Creatine and aging" source="ClinicalTrials.gov" externalId="NCT123" url=https://clinicaltrials.gov/study/NCT123 packet="--candidate-review-packet ${safeCandidateKey("clinicaltrials.gov|au|creatine|nct123")}" groupList="--candidates --candidate-region AU --candidate-source clinical-trials --candidates-limit 10" curationStatus="--candidate-curation-status ${safeCandidateKey("clinicaltrials.gov|au|creatine|nct123")}" curationDraft="--candidate-curation-draft ${safeCandidateKey("clinicaltrials.gov|au|creatine|nct123")}" decision="Accepted" reviewStatus="Human reviewed"`,
